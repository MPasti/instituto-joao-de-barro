...
=======
  ...
  return (
    <div className="registro">
      <h1 className="subtitle">Registro</h1>
      <p className="description">
        Este formulário é destinado exclusivamente a pessoas que realmente
        necessitam de assistência em relação à sua moradia. Pedimos que preencha
        as informações com atenção e honestidade, pois serão utilizadas para
        avaliar sua situação.
      </p>
      <p>
        Importante: O preenchimento deste formulário não garante a obtenção de
        uma vaga. Todas as solicitações serão submetidas a um processo de
        avaliação criterioso.
      </p>
      <div className="benefFormControl">
        {/* Campos do usuário */}
        <label>Email:</label>
...
>>>>>>> upstream/main
        ...
        <button className="btn-primary" onClick={registrarUser}>
          Confirmar
        </button>
      </div>
    </div>
